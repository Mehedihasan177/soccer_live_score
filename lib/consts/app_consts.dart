...
class AppConsts {
  ...
  static const String schedule = "/api/v2/football/schedules";
  static const String matchPreview = "/api/v1/match/preview";

  static const String matchDetailsHeader = "/api/v1/football/header";
  static const String matchLineUps = "/api/v1/match/lineups";
  static const String matchCommentary = "/api/v1/football/commentary";
  static const String matchStatistics = "/api/v1/match/statistics";

  static const String standingLeague = "/api/v1/football/standing/league";
